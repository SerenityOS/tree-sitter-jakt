...
vim.api.nvim_set_keymap("n", "<F2>", "<cmd>TermExec cmd='tree-sitter generate && tree-sitter test -d -f \"Namespace call functions in nested namespaces\"'<CR>", {noremap = true, silent = true})
