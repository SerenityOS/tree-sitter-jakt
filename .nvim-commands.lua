...
vim.api.nvim_set_keymap("n", "<F2>", "<cmd>TermExec cmd='tree-sitter generate && tree-sitter test -d -f \"Control flow try catch 2 (now with more call expressions)\"'<CR>", {noremap = true, silent = true})
