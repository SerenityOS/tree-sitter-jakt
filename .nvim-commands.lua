...
vim.api.nvim_set_keymap("n", "<F2>", "<cmd>TermExec cmd='tree-sitter generate && tree-sitter test -d -f \"Closures generic closure with parameter\"'<CR>", {noremap = true, silent = true})
